...
sylvain@ubuntu$ curl 52.47.191.104/
Holberton School for the win!
sylvain@ubuntu$ curl -sI 52.47.191.104/
HTTP/1.1 200 OK
...
sylvain@ubuntu$
In this example 52.47.191.104 is the IP of my web-01 server. If you want to query the Nginx that is locally installed on your server, you can use curl 127.0.0.1.
...
sylvain@ubuntu$ curl -sI 52.47.191.104/redirect_me/
...
sylvain@ubuntu$ curl -sI 52.47.191.104/xyz
...
sylvain@ubuntu$ curl 52.47.191.104/xyzfoo
...
Submit the URL of your 404 page in the field bellow or submit the file on your github account.
...
The custom 404 page is an illustration, design or fun page done by the student
